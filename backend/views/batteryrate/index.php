 ...
 */
$this->title = Yii::t('app', 'batteryrate_index') . '-' . Yii::$app->params['appName'];
?>
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="#">炮台命中率管理</a></li>
                <li class="active">炮台设置详情</li>
            </ul>
            <!--            面包屑结束            -->
                        ...
                        <table class="table table-bordered table-hover" style="border: 0px">
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= $value['batteryname'] ?></td>
