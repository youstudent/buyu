 ...
 */
$this->title = Yii::t('app', 'chat_index') . '-' . Yii::$app->params['appName'];
?>
<section id="content">
    <section class="vbox">
                    ...
                    <div class="row text-sm wrapper">
                        ...
                        <div class="col-sm-3 text-right">
                            <a href="<?= \yii\helpers\Url::to(['chat/add']) ?>" class="btn btn-primary"
                               data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>&nbsp;添加聊天内容</a>
                        </div>
                    </div>
                    <!--                搜索结束          -->
                </div>
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 120px;">
                                        <a href="<?php echo \yii\helpers\Url::to(['chat/edit', 'id' => $value['id']]) ?>"
                                           data-toggle="modal" data-target="#myModal" class="btn btn-xs btn-primary">编辑</a>
                                        <a href="<?php echo \yii\helpers\Url::to(['chat/del', 'id' => $value['id']]) ?>"
