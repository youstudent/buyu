                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" style="border: 0px">
                            ...
                            <tr>
                                ...
                                <th class="text-center">兑换金币所需钻石比例</th>
                                <th class="text-center">兑换宝石所需钻石比例</th>
                                <th class="text-center">玩家最小命中率</th>
                                <th class="text-center">玩家最大命中率</th>
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?=$value['goldrate']?></td>
                                    <td class="text-center"><?=$value['fishgoldrate']?></td>
