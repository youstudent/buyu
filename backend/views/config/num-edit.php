...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">修改系统配置数量参数</h4>
        </div>
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php echo $form->field($model,'sayworldcost')?>
                <?php echo $form->field($model,'leavemessagecost')?>
                <?php echo $form->field($model,'trident')?>
                <?php echo $form->field($model,'shotspeed')?>
                <?php echo $form->field($model,'unlockfishpower')?>
