 ...
 */
$this->title = Yii::t('app', 'currency_pay_index') . '-' . Yii::$app->params['appName'];
?>
<section id="content">
    <section class="vbox">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if(empty($data)):?>
                            <div class="text-center m-t-lg clearfix wrapper-lg animated fadeInRightBig" id="galleryLoading">
                                ...
                                <h4 class="text-muted"><?php echo sprintf(Yii::t('app','search_null'),'充值商城设置')?></h4>
                                <p class="m-t-lg"></p>
                            </div>
                        <?php endif;?>
                    </div>
