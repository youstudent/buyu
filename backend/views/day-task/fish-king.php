                ...
                <div class="panel-heading">
                    ...
                    <div class="row text-sm wrapper">
                        <div class=" text-right">
                            <a href="<?= \yii\helpers\Url::to(['day-task/add-king']) ?>" class="btn btn-primary"
                               data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>添加鱼王任务</a>
                        </div>
                    </div>
                    <!--                搜索结束          -->
                </div>
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 300px;">
                                        ...
                                        <a href="<?php echo \yii\helpers\Url::to(['day-task/update', 'id' => $value['id']]) ?>"
