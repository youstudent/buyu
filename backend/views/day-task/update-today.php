...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">修改每日斗金</h4>
        </div>
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php echo $form->field($model,'gold')->dropDownList(\backend\models\DayForm::$option)?>
                ...
                <?php foreach ($data as $k=>$v):?>
                    <div class="form-group field-notice-<?php  echo $k ?>" id=<?php echo $k?>>
                        ...
                        <div class="col-lg-9">
                            <input type="text" id="notice-<?php echo $k?>>" class="form-control" name="DayForm[type][<?php echo $k?>]" value="<?php echo $v?>">
