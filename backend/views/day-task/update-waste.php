...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">修改挥金如土</h4>
        </div>
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php echo $form->field($model,'type1')->dropDownList(\backend\models\OneCannonForm::$pay_out)?>
...
<script>
    $(document).ready(function () {
        ...
        //checkbox选中添加对应输入框
        var  checkbox_input =  $('#onecannonform-gives').find('.checkbox-inline');
        checkbox_input.click(function(){
            var _this = $(this);
            var input_text = _this.text();
            var input_name = 'OneCannonForm[type]['+ _this.find('input').val()+']';
