    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php echo $form->field($model,'batteryid')->dropDownList(['1'=>'是','0'=>'否'])?>
                <?php foreach ($data as $key=>$value):?>
                    <label class="col-lg-3 control-label" for="notice-gold">
                        <?php if ($data):?>
                            <?php echo  \common\helps\getgift::getGift()[$key]?>
                        <?php endif;?>
                    </label>
                    <div class="col-lg-9">
                        <input type="text" id="notice-gold>" class="form-control" name="day[gold]" value="<?php echo $value?>" readonly="">
