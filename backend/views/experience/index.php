 ...
 */
$this->title = Yii::t('app', 'experience_index') . '-' . Yii::$app->params['appName'];
?>
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="#">经验等级管理</a></li>
                <li class="active">经验等级管理详情</li>
            </ul>
            <!--            面包屑结束            -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" style="border: 0px">
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= $value['level']?>级</td>
                        ...
                        <?php if(empty($data)):?>
                            <div class="text-center m-t-lg clearfix wrapper-lg animated fadeInRightBig" id="galleryLoading">
                                ...
                                <h4 class="text-muted"><?php echo sprintf(Yii::t('app','search_null'),'经验等级管理')?></h4>
                                <p class="m-t-lg"></p>
                            </div>
                        <?php endif;?>
                    </div>
...
<script>
    ...
    function setStatus(val) {
        window.location = '<?php echo \yii\helpers\Url::to(['currency-pay/index','show'=>''],true)?>' + val;
