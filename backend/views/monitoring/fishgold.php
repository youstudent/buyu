...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">查看玩家宝石情况</h4>
        </div>
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php foreach ($data as $key=>$value):?>
                    ...
                    <div class="col-lg-9"><input type="text" id="redeemcode-diamond" class="form-control"
                     value="<?php echo $value?>" readonly=""><span class="help-block m-b-none"></span></div>
                <?php endforeach;?>
