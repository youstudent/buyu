            ...
            <section class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="row text-sm wrapper">
                        ...
                        <input type="hidden" name="Ranking[type]" value=3>
                        <div class="form-inline" style="margin-left: 20px; margin-right: 20px;">
                            <div class="form-group">
                                <span class="btn btn-primary btn-info">会员排行榜</span>
                        ...
                        <table class="table table-bordered table-hover" style="border: 0px">
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= $value->deposit ?></td>
                                </tr>
                                <?php $i++ ?>
                            <?php endforeach; ?>
                            </tbody>
