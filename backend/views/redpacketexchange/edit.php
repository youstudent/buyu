...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">修改红包个数</h4>
        </div>
        <div class="modal-body">
            ...
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                ...
                <?php echo $form->field($model,'redpacketnum')->textInput(['placeholder'=>'红包个数'])?>
                <?php echo $form->field($model,'type')->dropDownList(\backend\models\Redpacketexchange::$option)?>
                <?php echo $form->field($model,'num')->textInput(['placeholder'=>'数量'])?>
