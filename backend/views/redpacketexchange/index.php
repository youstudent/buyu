                ...
                <div class="panel-heading">
                    ...
                    <div class="row text-sm wrapper">
                        <div class="col-sm-3 text-left">
                            <a href="<?= \yii\helpers\Url::to(['redpacketexchange/add']) ?>" class="btn btn-primary"
                               data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>&nbsp;添加红包兑换</a>
                        </div>
                    </div>
                    <!--                搜索结束          -->
                </div>
                        ...
                        <table class="table table-bordered table-hover" style="border: 0px">
                            ...
                            <?php foreach ($data as $key => $value): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?=$value['redpacketnum']?></td>
                                    <td class="text-center"><?=$value['num']?></td>
                                    <td class="text-center"><?=\backend\models\Redpacketexchange::$option[$value['type']]?></td>
                                    <td class="text-center" style="width: 300px;">
                                        <a href="<?php echo \yii\helpers\Url::to(['redpacketexchange/edit', 'id' => $value['id']]) ?>"
                                           data-toggle="modal" data-target="#myModal" class="btn btn-xs btn-primary">编辑</a>
                                        <a href="<?php echo \yii\helpers\Url::to(['redpacketexchange/del', 'id' => $value['id']]) ?>"
