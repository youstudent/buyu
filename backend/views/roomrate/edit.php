...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">修改房间命中率</h4>
        </div>
        <div class="modal-body">
            <div class="col-xs-11">
            <?php $form = \yii\bootstrap\ActiveForm::begin([
                    'id'=>'payModalForm',
                    'action'=>['roomrate/edit'],
                ...
                <?php echo $form->field($model,'number')->textInput(['readonly'=>true])?>
                <?php echo $form->field($model,'minrate')?>
