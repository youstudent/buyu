 ...
 */
$this->title = Yii::t('app', 'vip_index') . '-' . Yii::$app->params['appName'];
?>
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="#">vip每日福利管理</a></li>
                <li class="active">vip每日福利管理详情</li>
            </ul>
            <!--            面包屑结束            -->
                ...
                <div class="panel-heading">
                    ...
                    <div class="row text-sm wrapper">
                        <div class="col-sm-3 text-left">
                            <a href="<?= \yii\helpers\Url::to(['vip-benefit/add'])?>" class="btn btn-primary"
                               data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>添加Vip等级</a>
                        </div>
                    </div>
                    <!--                搜索结束          -->
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if(empty($data)):?>
                            <div class="text-center m-t-lg clearfix wrapper-lg animated fadeInRightBig" id="galleryLoading">
                                ...
                                <h4 class="text-muted"><?php echo sprintf(Yii::t('app','search_null'),'vip每日福利管理')?></h4>
                                <p class="m-t-lg"></p>
                            </div>
                        <?php endif;?>
                    </div>
