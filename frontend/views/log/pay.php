 ...
 */
$this->title = "购买记录-".\Yii::$app->params['appName'];
                        ...
                        <div class="col-sm-9">
                            <div class="form-inline">
                                <div class="form-group">
                                    <form action="<?=\yii\helpers\Url::to(['log/pay'])?>" method="get" id="lr_form">
                                        <div class="form-group">
                                            <div class="controls">
                               ...
                               <!-- <td  class="text-center"><?/*=$value['money']*/?></td>-->
                                ...
                                <td class="text-center" style="border-right: 0px;">
                                    ...
                                    <?php elseif ($value['status'] == 2):?>
                                        <span class="badge  bg-success">充值完成</span>
...
<!--                        未找到任何数据显示-->
                    <?php if(empty($data)):?>
                        <div class="text-center m-t-lg clearfix wrapper-lg animated fadeInRightBig" id="galleryLoading">
                            ...
                            <h4 class="text-muted">非常抱歉,我们未能找到"购买记录"相关的任何数据!</h4>
                            <p class="m-t-lg"></p>
                        </div>
                    <?php endif;?>
<!--                        为找到任何数据显示结束-->
