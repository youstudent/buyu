                        ...
                        <div class="form-inline" style="margin-left: 20px; margin-right: 20px;">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <a href="<?= \yii\helpers\Url::to(['withdraw/add']) ?>" class="btn btn-primary"
                                       data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>申请提现</a>
                                </div>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <?php foreach ($data as $key => $value):?>
                            <tr>
                                ...
                                <td  class="text-center"><?=\frontend\models\Withdraw::$option_type[$value['type']]?></td>
